...
int main()
{
    ...
    if (pipe != NULL)
    {
        ...
        fprintf(pipe, "set xlabel 'Prey Population'\n");
        fprintf(pipe, "set ylabel 'Predator population'\n");
        fprintf(pipe, "set title 'Phase Plane Plot'\n");
        fprintf(pipe, "plot '-' using 1:2 title 'Phase Plane Plot' with lines\n");
